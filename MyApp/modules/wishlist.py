...
@bp.route('/wishlist/<int:wishlist_id>/book/<int:book_id>', methods=['POST'])
...
@bp.route('/wishlist/<int:wishlist_id>/books', methods=['GET'])
...
@bp.route('/wishlist/<int:wishlist_id>/book/<int:book_id>', methods=['DELETE'])
